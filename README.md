...
_**В этом репозитории собраны проекты, над которыми я работаю, пока ищу работу на позицию Java-разработчика. 
...
**Примечание:** 
   - _Приложения простые, поэтому единственная цель — тестирование._
